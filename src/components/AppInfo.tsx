      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center">
          <div className="flex justify-center gap-4 mb-8">
            ...
            <a href="https://instagram.com/droplinkspace" className="text-muted-foreground hover:text-primary transition-colors">
              <Instagram className="h-6 w-6" />
            </a>
            <a href="mailto:hello@droplinkspace" className="text-muted-foreground hover:text-primary transition-colors">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <a href="https://status.droplinkspace" className="text-muted-foreground hover:text-primary transition-colors flex items-center gap-1">
              System Status
