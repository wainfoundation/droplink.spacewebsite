...
const CustomerSuccessStories = () => {
  // Generate avatar URL from name using DiceBear API
  ...
  const successStories = [
    {
      ...
      role: "Digital Artist",
      avatar: getAvatarUrl("Elena Rodriguez"),
      profileImage: getAvatarUrl("Elena Rodriguez"),
    ...
    },
    {
      ...
      profileImage: getAvatarUrl("Marcus Chen"),
    ...
    },
    {
      ...
      avatar: getAvatarUrl("Sarah Kim"),
      profileImage: getAvatarUrl("Sarah Kim"),
                    ...
                    <div className="flex items-center gap-3 sm:gap-4 mb-4 sm:mb-6">
                      <img 
                        ...
                        onError={(e) => {
                          ...
                          img.src = `https://ui-avatars.com/api/?name=${encodeURIComponent(firstName)}&background=0D8ABC&color=fff&rounded=true&size=120`;
                        }}
                      />
                      <div>
