        ...
        <div className="max-w-3xl mx-auto">
          <Accordion type="single" collapsible className="w-full">
            ...
            <AccordionItem value="item-3">
              ...
              <AccordionContent>
                Starter (10π/month): Unlimited links, basic analytics, and tip withdrawals. 
                Pro (20π/month): Advanced tools like QR codes and animations. 
                Premium (30π/month): All Pro features plus priority support and whitelabel options. Billed annually.
              </AccordionContent>
            </AccordionItem>
            ...
            <AccordionItem value="item-5">
              ...
              <AccordionContent>
                ...
                Upgrade to Starter (10π/month) to unlock unlimited links, analytics, and more features.
              </AccordionContent>
            </AccordionItem>
