      ...
      <table className="w-full border-collapse mt-12">
        <thead>
          <tr className="bg-blue-50">
            ...
            <th className="p-4 text-center border-b-2 border-blue-200 bg-blue-100">Pro<br/><span className="text-sm font-normal">20π/month</span></th>
            <th className="p-4 text-center border-b-2 border-blue-200">Premium<br/><span className="text-sm font-normal">30π/month</span></th>
          </tr>
        </thead>
        <tbody>
