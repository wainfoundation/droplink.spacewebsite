...
export const faqData: FAQCategory[] = [
  {
    ...
    questions: [
      ...
      },
      {
        ...
        answer: "Yes! Droplink offers a free plan that includes unlimited links, basic analytics, and one theme. You can upgrade to paid plans (Starter: 10π, Pro: 20π, Premium: 30π) for additional features like premium themes, advanced analytics, and custom domains."
      },
      {
