              ...
              <div className="bg-muted p-8 rounded-xl">
                ...
                <div className="mt-12 pt-6 border-t border-border">
                  ...
                  <div className="flex gap-4">
                    <a href="https://twitter.com/droplink_space" className="bg-background p-3 rounded-full hover:bg-sky-100 transition-colors">
                      <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="currentColor" className="text-sky-500"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24h-6.6l-5.165-6.75-5.97 6.75H2.556l7.73-8.835L1.488 2.25h6.767l4.682 6.18 5.371-6.18zM17.15 18.75h1.833L6.822 4.157H4.881l12.269 14.593z" /></svg>
                    </a>
