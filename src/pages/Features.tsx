      ...
      <main className="flex-grow pt-20 py-12 px-6">
        <div className="container mx-auto">
          ...
          <div className="mt-16 text-center space-y-4">
            <div>
              <Link to="/demo">
                <Button size="lg" className="bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 mb-4">
            ...
            <div>
              <Link to="/pricing">
                <Button size="lg" variant="outline" className="bg-gradient-hero hover:bg-secondary">
                  View Pricing Plans
                </Button>
              </Link>
            </div>
